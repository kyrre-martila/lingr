...
const snapshot = {
  ...
  discovery: { state: 'ready', limitPerDay: 3, remaining: 2, reasonCode: null, introductions: [{ userId: 'usr_mock_a', layersSummary: 'Grounded and reflective', bio: 'Taking things slowly.', glimpses: [{ glimpsId: 'glp_1', reflection: 'I value repair after conflict.', mood: 'Calm', prompt: 'What helps you feel safe?', emotionalTone: 'grounded' }] }] },
