...
const conversationTemplate = [
  { id: 'c1', name: 'Maya', mood: 'Soft curiosity', updatedAt: 'Today · 8:10 PM', unread: false, paused: false, preview: 'I have been thinking about your question from yesterday.', messages: [
  ...
  { id: 'c2', name: 'Noor', mood: 'Reflective', updatedAt: 'Yesterday', unread: false, paused: true, preview: 'Paused for reflection until Friday.', messages: [], nextPromptAt: 'Friday evening' },
  { id: 'c3', name: 'Eli', mood: 'Gentle momentum', updatedAt: '2 days ago', unread: false, paused: false, preview: 'I feel most present when I am walking without my phone.', messages: [
