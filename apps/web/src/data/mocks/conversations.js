...
const conversationTemplate = [
  { id: 'c1', name: 'Maya', mood: 'Soft curiosity', updatedAt: 'Today · 8:10 PM', unread: false, paused: false, windowState: WINDOW_STATES.OPEN, windowRhythm: WINDOW_RHYTHMS.GENTLE, emotionalSpaceLevel: 'steady', mutualParticipationReady: true, preview: 'I have been thinking about your question from yesterday.', messages: [
    ...
    { id: 'm1b', sender: 'them', type: 'layer_unlock', content: { title: 'You unlocked a new layer', subtitle: 'A little more of this profile is now visible', ctaLabel: 'See more about Maja' }, text: 'Layer unlocked', time: '7:45 PM' },
  ...
  ], nextPromptAt: 'Tomorrow morning', compatibilityProfile: createCompatibilityProfile({ communicationPreference: 'reflective', emotionalPace: 'steady', conversationStyle: 'curious', valuesAlignment: ['care', 'honesty', 'growth'], socialEnergy: 'balanced', relationshipIntention: 'intentional_connection', emotionalSafetyPreference: 'gentle_clarity' }) , safetyContext: { mutualConsistency: true, consentClarity: true, repairAttempts: 0, messageIntervalHours: 10, isLateNight: false, includesSensitiveTopic: false, boundaryMentioned: false, unresolvedTension: false }, boundaryPreferences: { pace: 'steady', preferredResponseWindowHours: 12, consentForLateNightPrompts: false, allowSensitiveTopics: true } },
  { id: 'c2', name: 'Noor', mood: 'Reflective', updatedAt: 'Yesterday', unread: false, paused: true, windowState: WINDOW_STATES.PAUSED, windowRhythm: WINDOW_RHYTHMS.REFLECTIVE, emotionalSpaceLevel: 'tender', mutualParticipationReady: true, preview: 'Paused for reflection until Friday.', messages: [], nextPromptAt: 'Friday evening', compatibilityProfile: createCompatibilityProfile({ communicationPreference: 'reflective', emotionalPace: 'slow', conversationStyle: 'reflective', valuesAlignment: ['care', 'trust', 'family'], socialEnergy: 'calm', relationshipIntention: 'intentional_connection', emotionalSafetyPreference: 'paced_space' }) , safetyContext: { mutualConsistency: true, consentClarity: true, repairAttempts: 1, messageIntervalHours: 20, isLateNight: false, includesSensitiveTopic: false, boundaryMentioned: false, unresolvedTension: false }, boundaryPreferences: { pace: 'slow', preferredResponseWindowHours: 18, consentForLateNightPrompts: false, allowSensitiveTopics: false } },
  ...
  ], nextPromptAt: 'In 6 hours', compatibilityProfile: createCompatibilityProfile({ communicationPreference: 'direct_kind', emotionalPace: 'steady', conversationStyle: 'curious', valuesAlignment: ['growth', 'adventure', 'care'], socialEnergy: 'balanced', relationshipIntention: 'exploring_connection', emotionalSafetyPreference: 'gentle_clarity' }) , safetyContext: { mutualConsistency: false, consentClarity: true, repairAttempts: 2, messageIntervalHours: 4, isLateNight: true, includesSensitiveTopic: true, boundaryMentioned: true, unresolvedTension: true }, boundaryPreferences: { pace: 'steady', preferredResponseWindowHours: 12, consentForLateNightPrompts: false, allowSensitiveTopics: false } }
]
